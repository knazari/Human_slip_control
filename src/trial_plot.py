...
user_path = "/home/kia/catkin_ws/src/data_collection_human_test/data/real_test2/" + name + "/" + stage
...
object_rotation -= object_rotation[0]
...
ax[2].vlines(start_index, 0, max(xela_data))
ax[2].vlines(end_index, 0, max(xela_data))
