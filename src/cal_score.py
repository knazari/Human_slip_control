...
subject_baseline_data_path = "/home/kia/catkin_ws/src/data_collection_human_test/data/subject_003/baseline"
subject_controlled_data_path = "/home/kia/catkin_ws/src/data_collection_human_test/data/subject_003/controlled"
...
last_task_time = pd.read_csv(controlled_files[-1] + '/meta_data.csv')['task_completion_time']
...
time_increase_perc = ((last_task_time - mean_baseline_time) / mean_baseline_time)[0] * 100
